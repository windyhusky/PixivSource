...
| ----- | --- | ----------------------- | -------------------------- | ----------------------------------------- |
| Pixiv | ✅ | ✅ 全站 ✅ 兽人 | ✅ 单篇 ✅ 系列 ⭕️ 小说插画 | ✅ 搜索 ✅ 发现 ❌ 添加网址 ❌ 配套订阅源 |
| Linpx | ✅ | ❌ 全站 ✅ 兽人 | ✅ 单篇 ✅ 系列 ⭕️ 小说插画 | ✅ 搜索 ✅ 发现 ✅ 添加网址 ✅ 配套订阅源 |
...
| 下载站点                                                     | 版本           | 备注                 |
| ------------------------------------------------------------ | -------------- | -------------------- |
| [Github Release](https://github.com/gedoor/legado/releases/latest) | 有限制，稳定版 | 需要代理，需要登录|
