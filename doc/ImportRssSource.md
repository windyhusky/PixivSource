...
head:
  - - meta
    - name: keywords
      content: 导入订阅源, Legado 订阅源, 开源阅读订阅源, BTSRK 订阅源, Pixiv 订阅源, 一键导入订阅源, 订阅源规则订阅, 书源自动更新, 阅读 RSS 订阅
  - - meta
    - property: og:title
      content: 导入订阅源 - 开源阅读 导入订阅源教程
  - - meta
...
> [!NOTE]
>
> 📖 **你正在 GitHub 上浏览此文档， [网页版](https://pixivsource.pages.dev/ImportRssSource) 内容更全面，排版更精美**
</div>


> [!TIP]
> **开源阅读 Legado 订阅源导入 指南**
>
> **另有：新手配置指南：**
