...
function urlIP(url) {
    ...
    let isIPDirect = JSON.parse(String(source.variableComment).match(RegExp(/{([\s\S]*?)}/gm))).IPDirect || false
    if (isIPDirect) {
...
<body>
    <table border="1" cellspacing="0">
        <th colspan="2"> ${source.bookSourceName} 书源 <a href="https://github.com/DowneyRem/PixivSource/blob/main/doc/${sourceNameCapitalize}.md">🔰 使用指南</a></th>
        <tr>
